...
namespace Companies.API.Data
{
    public class SeedData
    {
        ...
        private static ICollection<Employee> GenerateEmployees(int nrOfEmployees, IEnumerable<Department> departments)
        {
            ...
            var faker = new Faker<Employee>("sv").Rules((f, e) =>
            {
                ...
                e.Department = departmentList[f.Random.Int(min: 0, max: departmentList.Count - 1)];
            });
